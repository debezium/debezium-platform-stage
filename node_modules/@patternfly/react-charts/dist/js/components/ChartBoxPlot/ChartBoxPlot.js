...
const ChartBoxPlot = (_a) => {
    ...
    return React.createElement(victory_box_plot_1.VictoryBoxPlot, Object.assign({ containerComponent: container, theme: theme }, rest));
};
exports.ChartBoxPlot = ChartBoxPlot;
exports.ChartBoxPlot.displayName = 'ChartBoxPlot';
// Note: VictoryBar.getDomain & VictoryBar.role must be hoisted
(0, hoist_non_react_statics_1.default)(exports.ChartBoxPlot, victory_box_plot_1.VictoryBoxPlot);
