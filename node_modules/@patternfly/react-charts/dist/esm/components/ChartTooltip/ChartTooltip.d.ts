...
import { NumberOrCallback, OrientationTypes, StringOrNumberOrCallback, TextAnchorType, OrientationOrCallback, VictoryStyleObject } from 'victory-core';
...
export declare const ChartTooltip: React.FunctionComponent<ChartTooltipProps>;
