...
import { AnimatePropTypeInterface, CategoryPropType, D3Scale, DataGetterPropType, DomainPropType, DomainPaddingPropType, EventCallbackInterface, EventPropTypeInterface, NumberOrCallback, OriginType, PaddingProps, RangePropType, ScalePropType, SortOrderPropType, StringOrNumberOrCallback, StringOrNumberOrList, VictoryStyleInterface } from 'victory-core';
import { VictoryBarAlignmentType, VictoryBarProps, VictoryBarTTargetType } from 'victory-bar';
...
export declare const ChartBar: React.FunctionComponent<ChartBarProps>;
