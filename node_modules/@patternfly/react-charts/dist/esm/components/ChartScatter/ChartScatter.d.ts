...
import { AnimatePropTypeInterface, CategoryPropType, D3Scale, DataGetterPropType, DomainPropType, DomainPaddingPropType, EventCallbackInterface, EventPropTypeInterface, OriginType, PaddingProps, RangePropType, ScalePropType, ScatterSymbolType, SortOrderPropType, StringOrNumberOrCallback, StringOrNumberOrList, VictoryStyleInterface } from 'victory-core';
import { VictoryScatterProps, VictoryScatterTTargetType } from 'victory-scatter';
...
export declare const ChartScatter: React.FunctionComponent<ChartScatterProps>;
