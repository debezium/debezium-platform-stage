...
import { NumberOrCallback, OrientationOrCallback, StringOrNumberOrCallback, TextAnchorType, VictoryStyleObject } from 'victory-core';
import { ChartCursorTooltipProps } from '../ChartCursorTooltip/ChartCursorTooltip';
...
export interface ChartLegendTooltipProps extends Omit<ChartCursorTooltipProps, 'title'> {
     ...
     */
    events?: {
        [key: string]: (event: React.SyntheticEvent<any>) => void;
    };
    /**
...
export declare const ChartLegendTooltip: React.FunctionComponent<ChartLegendTooltipProps>;
//# sourceMappingURL=ChartLegendTooltip.d.ts.map