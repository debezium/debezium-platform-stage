...
const FormGroupLabelHelpBase = (_a) => {
    ...
    return (react_1.default.createElement(Button_1.Button, Object.assign({ component: "span", isInline: true, ref: buttonRef, onKeyDown: handleKeyDown, "aria-label": ariaLabel, className: className, variant: "plain", hasNoPadding: true }, props),
        react_1.default.createElement(question_circle_icon_1.default, null)));
};
