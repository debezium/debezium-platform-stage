...
const ActionList = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(action_list_1.default.actionList, isIconList && action_list_1.default.modifiers.icons, className) }, props), children));
};
