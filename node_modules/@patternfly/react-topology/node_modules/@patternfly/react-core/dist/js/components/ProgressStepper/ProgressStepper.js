...
const ProgressStepper = (_a) => {
    ...
    return (React.createElement("ol", Object.assign({ className: (0, react_styles_1.css)(progress_stepper_1.default.progressStepper, isCenterAligned && progress_stepper_1.default.modifiers.center, isVertical && progress_stepper_1.default.modifiers.vertical, isCompact && progress_stepper_1.default.modifiers.compact, className), role: "list", "aria-label": ariaLabel }, props), children));
};
