...
const DataListItemRow = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(data_list_1.default.dataListItemRow, className, wrapModifier && data_list_1.default.modifiers[wrapModifier]) }, props), React.Children.map(children, (child) => React.isValidElement(child) &&
