    ...
    const buildSearchTextInputGroupWithExtraButtons = (_a = {}) => {
        ...
        return (React.createElement(InputGroup_1.InputGroup, Object.assign({ ref: triggerRef }, searchInputProps),
            ...
            (attributes.length > 0 || onToggleAdvancedSearch) && (React.createElement(InputGroup_1.InputGroupItem, { isPlain: true },
                React.createElement(Button_1.Button, { className: isSearchMenuOpen && 'pf-m-expanded', variant: Button_1.ButtonVariant.control, "aria-label": openMenuButtonAriaLabel, onClick: onToggle, isDisabled: isDisabled, "aria-expanded": isSearchMenuOpen },
                    React.createElement(caret_down_icon_1.default, null)))),
            !!onSearch && (React.createElement(InputGroup_1.InputGroupItem, null,
                React.createElement(Button_1.Button, { type: "submit", variant: Button_1.ButtonVariant.control, "aria-label": submitSearchButtonLabel, onClick: onSearchHandler, isDisabled: isDisabled },
                    React.createElement(Icon_1.Icon, { shouldMirrorRTL: true },
