...
const Badge = (_a) => {
    ...
    return (React.createElement("span", Object.assign({}, props, { className: (0, react_styles_1.css)(badge_1.default.badge, (isRead ? badge_1.default.modifiers.read : badge_1.default.modifiers.unread), isDisabled && badge_1.default.modifiers.disabled, className) }),
        children,
