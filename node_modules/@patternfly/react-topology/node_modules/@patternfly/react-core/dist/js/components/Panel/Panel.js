...
const PanelBase = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(panel_1.default.panel, variant && panel_1.default.modifiers[variant], isScrollable && panel_1.default.modifiers.scrollable, className), ref: innerRef }, props), children));
};
