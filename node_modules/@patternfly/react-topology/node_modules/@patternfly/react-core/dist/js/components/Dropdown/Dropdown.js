...
const DropdownBase = (_a) => {
    ...
    const menu = (react_1.default.createElement(Menu_1.Menu, Object.assign({ className: (0, react_styles_1.css)(className), ref: menuRef, onSelect: (event, value) => {
