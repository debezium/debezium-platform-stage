...
const OverflowMenuContent = ({ className, children, isPersistent }) => (React.createElement(OverflowMenuContext_1.OverflowMenuContext.Consumer, null, (value) => (!value.isBelowBreakpoint || isPersistent) && (React.createElement("div", { className: (0, react_styles_1.css)(overflow_menu_1.default.overflowMenuContent, className) }, children))));
