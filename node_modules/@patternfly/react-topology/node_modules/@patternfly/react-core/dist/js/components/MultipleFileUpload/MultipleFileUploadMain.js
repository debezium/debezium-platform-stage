...
const MultipleFileUploadMain = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(multiple_file_upload_1.default.multipleFileUploadMain, className) }, props),
        ...
        isUploadButtonHidden || React.createElement(MultipleFileUploadButton_1.MultipleFileUploadButton, { browseButtonText: browseButtonText }),
