    ...
    render() {
        ...
        return (React.createElement(Nav_1.NavContext.Consumer, null, ({ isHorizontal }) => (React.createElement(PageSidebar_1.PageSidebarContext.Consumer, null, ({ isSidebarOpen }) => (React.createElement(React.Fragment, null,
            isHorizontal && (!scrollViewAtStart || !scrollViewAtEnd) && (React.createElement("div", { className: (0, react_styles_1.css)(nav_1.default.navScrollButton) },
                React.createElement(Button_1.Button, { variant: "plain", "aria-label": backScrollAriaLabel, onClick: this.scrollBack, isDisabled: scrollViewAtStart, tabIndex: isSidebarOpen ? null : -1 },
            ...
            isHorizontal && (!scrollViewAtStart || !scrollViewAtEnd) && (React.createElement("div", { className: (0, react_styles_1.css)(nav_1.default.navScrollButton) },
                React.createElement(Button_1.Button, { variant: "plain", "aria-label": forwardScrollAriaLabel, onClick: this.scrollForward, isDisabled: scrollViewAtEnd, tabIndex: isSidebarOpen ? null : -1 },
