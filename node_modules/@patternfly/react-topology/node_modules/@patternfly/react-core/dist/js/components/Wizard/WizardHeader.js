...
const WizardHeader = ({ onClose = () => undefined, title, description, isCloseHidden, closeButtonAriaLabel, titleId, descriptionComponent: Component = 'div', descriptionId }) => (React.createElement("div", { className: (0, react_styles_1.css)(wizard_1.default.wizardHeader) },
    !isCloseHidden && (React.createElement("div", { className: (0, react_styles_1.css)(wizard_1.default.wizardClose) },
        React.createElement(Button_1.Button, { variant: "plain", "aria-label": closeButtonAriaLabel, onClick: onClose },
