...
const FileUploadField = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(file_upload_1.default.fileUpload, isDragActive && file_upload_1.default.modifiers.dragHover, isLoading && file_upload_1.default.modifiers.loading, className), ref: containerRef }, props),
        React.createElement("div", { className: file_upload_1.default.fileUploadFileSelect },
            React.createElement(InputGroup_1.InputGroup, null,
                React.createElement(InputGroup_1.InputGroupItem, { isFill: true },
                    React.createElement(TextInput_1.TextInput, { readOnlyVariant: "default" // Always read-only regardless of isReadOnly prop (which is just for the TextArea)
                ...
                React.createElement(InputGroup_1.InputGroupItem, null,
                    React.createElement(Button_1.Button, { variant: Button_1.ButtonVariant.control, onClick: onBrowseButtonClick, isDisabled: isDisabled, "aria-describedby": browseButtonAriaDescribedby }, browseButtonText)),
                React.createElement(InputGroup_1.InputGroupItem, null,
