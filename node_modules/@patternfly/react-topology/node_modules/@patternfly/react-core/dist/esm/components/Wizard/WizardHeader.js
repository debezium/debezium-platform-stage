...
export const WizardHeader = ({ onClose = () => undefined, title, description, isCloseHidden, closeButtonAriaLabel, titleId, descriptionComponent: Component = 'div', descriptionId }) => (React.createElement("div", { className: css(styles.wizardHeader) },
    !isCloseHidden && (React.createElement("div", { className: css(styles.wizardClose) },
        React.createElement(Button, { variant: "plain", "aria-label": closeButtonAriaLabel, onClick: onClose },
