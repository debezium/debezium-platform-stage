...
export const Label = (_a) => {
    ...
    const content = (React.createElement(React.Fragment, null,
        _icon && React.createElement("span", { className: css(styles.labelIcon) }, _icon),
