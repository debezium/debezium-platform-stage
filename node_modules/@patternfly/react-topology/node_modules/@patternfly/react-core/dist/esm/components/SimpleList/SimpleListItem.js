...
class SimpleListItem extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(SimpleListContext.Consumer, null, ({ currentRef, updateCurrentRef, isControlled }) => {
            ...
            return (React.createElement("li", Object.assign({ className: css('pf-v6-c-simple-list__item', className) }, props),
                React.createElement(Component, Object.assign({ className: css(styles.simpleListItemLink, isCurrentItem && styles.modifiers.current, !isButton && styles.modifiers.link, componentClassName), onClick: (evt) => {
                        onClick(evt);
