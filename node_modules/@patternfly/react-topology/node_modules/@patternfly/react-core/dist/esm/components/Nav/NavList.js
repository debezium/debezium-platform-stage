    ...
    render() {
        ...
        return (React.createElement(NavContext.Consumer, null, ({ isHorizontal }) => (React.createElement(PageSidebarContext.Consumer, null, ({ isSidebarOpen }) => (React.createElement(React.Fragment, null,
            isHorizontal && (!scrollViewAtStart || !scrollViewAtEnd) && (React.createElement("div", { className: css(styles.navScrollButton) },
                React.createElement(Button, { variant: "plain", "aria-label": backScrollAriaLabel, onClick: this.scrollBack, isDisabled: scrollViewAtStart, tabIndex: isSidebarOpen ? null : -1 },
            ...
            isHorizontal && (!scrollViewAtStart || !scrollViewAtEnd) && (React.createElement("div", { className: css(styles.navScrollButton) },
                React.createElement(Button, { variant: "plain", "aria-label": forwardScrollAriaLabel, onClick: this.scrollForward, isDisabled: scrollViewAtEnd, tabIndex: isSidebarOpen ? null : -1 },
