...
const TaskBadge = React.forwardRef(({ badge, badgeTextColor, badgeColor, badgeBorderColor, badgeClassName, className, x, y }, iconRef) => {
    ...
    return (React.createElement("g", { className: classes, transform: `translate(${x}, ${y})` },
        rect,
        typeof badge === 'string' ? (React.createElement("text", { fill: badgeTextColor || badgeClassName ? undefined : color_blue_30_2.color_blue_30.value, ref: textRef, x: width / 2 + paddingX, y: height / 2, textAnchor: "middle", dy: "0.35em" }, badge)) : (React.createElement("foreignObject", { ref: textRef }, badge))));
});
