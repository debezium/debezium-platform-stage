...
exports.ColaGroupsNode = void 0;
const types_1 = require("../types");
const LayoutNode_1 = require("./LayoutNode");
const geom_1 = require("../geom");
class ColaGroupsNode extends LayoutNode_1.LayoutNode {
        ...
        if (!this.isFixed && this.xx != null && this.yy != null) {
            if (this.node.isGroup()) {
                ...
                this.node.getChildren().forEach((child) => {
                    if ((0, types_1.isNode)(child)) {
                        const node = child;
                        const position = node.getPosition();
                        node.setPosition(new geom_1.Point(position.x + xOffset, position.y + yOffset));
                    }
                });
            }
            else {
...
exports.ColaGroupsNode = ColaGroupsNode;
