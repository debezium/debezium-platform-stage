...
class BaseLayout {
    constructor(graph, options) {
        ...
        this.getLeafNodes = () => (0, utils_1.leafNodeElements)(this.graph.getNodes()).filter((n) => n.isVisible());
        this.getGroupNodes = () => (0, utils_1.groupNodeElements)(this.graph.getNodes()).filter((g) => g.isVisible());
        this.hasVisibleChildren = (group) => !!group.getNodes().find((c) => (0, types_1.isNode)(c) && c.isVisible());
        (0, mobx_1.makeObservable)(this, { runLayout: mobx_1.action });
        this.graph = graph;
        this.options = Object.assign(Object.assign(Object.assign({}, exports.LAYOUT_DEFAULTS), { onSimulationEnd: this.onSimulationEnd, listenForChanges: true }), options);
    ...
    getLayoutNode(nodes, node) {
        ...
        if (!layoutNode) {
            layoutNode = this.getLayoutNode(nodes, (0, utils_1.getClosestVisibleParent)(node));
        }
        return layoutNode;
    }
