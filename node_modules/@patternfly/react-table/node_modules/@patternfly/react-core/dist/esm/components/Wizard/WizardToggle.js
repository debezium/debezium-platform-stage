    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("button", { onClick: toggleNavExpanded, className: css(styles.wizardToggle, isNavExpanded && 'pf-m-expanded'), "aria-label": ariaLabel, "aria-expanded": isNavExpanded },
            React.createElement("span", { className: css(styles.wizardToggleList) },
                React.createElement("span", { className: css(styles.wizardToggleListItem, isActiveStepStatus === 'error' && styles.modifiers.danger) },
                    isActiveStepStatus === 'error' ? (React.createElement("span", { className: css(styles.wizardToggleStatusIcon) },
                        React.createElement(ExclamationCircleIcon, null))) : (React.createElement("span", { className: css(styles.wizardToggleNum) }, wizardToggleIndex)),
                    ' ',
