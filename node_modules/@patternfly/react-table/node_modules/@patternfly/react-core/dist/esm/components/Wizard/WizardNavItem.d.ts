...
export declare const WizardNavItem: {
    ({ children, content, isCurrent, isDisabled, isVisited, stepIndex, onClick, component: NavItemComponent, href, isExpandable, id, status, target, ouiaId, ouiaSafe, className, ...props }: WizardNavItemProps): React.JSX.Element;
    displayName: string;
};
