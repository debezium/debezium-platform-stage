...
const WizardContextProvider = ({ steps: initialSteps, footer: initialFooter, activeStepIndex, children, onNext, onBack, onClose, goToStepById, goToStepByName, goToStepByIndex, shouldFocusContent, mainWrapperRef }) => {
    ...
    const [currentFooter, setCurrentFooter] = react_1.default.useState();
    ...
    const activeStep = react_1.default.useMemo(() => steps.find((step) => step.index === activeStepIndex), [activeStepIndex, steps]);
    ...
    return (react_1.default.createElement(exports.WizardContext.Provider, { value: {
            ...
            goToStepByIndex: react_1.default.useCallback((index) => goToStepByIndex(null, steps, index), [goToStepByIndex, steps]),
            shouldFocusContent,
            mainWrapperRef
        } }, children));
};
