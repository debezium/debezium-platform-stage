...
const LoginPage = (_a) => {
    ...
    return (React.createElement(React.Fragment, null,
        backgroundImgSrc && React.createElement(BackgroundImage_1.BackgroundImage, { src: backgroundImgSrc }),
        React.createElement(Login_1.Login, Object.assign({ header: Header, footer: Footer, className: (0, react_styles_1.css)(className) }, props),
            React.createElement(LoginMainHeader_1.LoginMainHeader, { title: loginTitle, subtitle: loginSubtitle, headerUtilities: headerUtilities }),
            React.createElement(LoginMainBody_1.LoginMainBody, null, children),
            (socialMediaLoginContent || forgotCredentials || signUpForAccountMessage) && (React.createElement(LoginMainFooter_1.LoginMainFooter, { socialMediaLoginContent: socialMediaLoginContent, socialMediaLoginAriaLabel: socialMediaLoginAriaLabel, forgotCredentials: forgotCredentials, signUpForAccountMessage: signUpForAccountMessage })))));
};
