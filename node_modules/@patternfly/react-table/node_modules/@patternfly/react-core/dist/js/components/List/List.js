...
const List = (_a) => {
    ...
    return component === ListComponent.ol ? (React.createElement("ol", Object.assign({ ref: ref, type: type }, (isPlain && { role: 'list' }), props, { className: (0, react_styles_1.css)(list_1.default.list, variant && list_1.default.modifiers[variant], isBordered && list_1.default.modifiers.bordered, isPlain && list_1.default.modifiers.plain, iconSize && iconSize === 'large' && list_1.default.modifiers.iconLg, className) }), children)) : (React.createElement("ul", Object.assign({ ref: ref }, (isPlain && { role: 'list' }), props, { className: (0, react_styles_1.css)(list_1.default.list, variant && list_1.default.modifiers[variant], isBordered && list_1.default.modifiers.bordered, isPlain && list_1.default.modifiers.plain, iconSize && iconSize === 'large' && list_1.default.modifiers.iconLg, className) }), children));
};
exports.List = List;
