...
const ProgressContainer = ({ progressBarAriaProps, value, title = '', parentId, label = null, variant = null, measureLocation = ProgressMeasureLocation.top, isTitleTruncated = false, tooltipPosition, helperText }) => {
    ...
    const Title = (React.createElement("div", { className: (0, react_styles_1.css)(progress_1.default.progressDescription, isTitleTruncated && typeof title === 'string' && progress_1.default.modifiers.truncate), id: `${parentId}-description`, "aria-hidden": "true", onMouseEnter: isTitleTruncated && typeof title === 'string' ? onMouseEnter : null }, title));
    return (React.createElement(React.Fragment, null,
        ...
        (measureLocation !== ProgressMeasureLocation.none || StatusIcon) && (React.createElement("div", { className: (0, react_styles_1.css)(progress_1.default.progressStatus), "aria-hidden": "true" },
            (measureLocation === ProgressMeasureLocation.top || measureLocation === ProgressMeasureLocation.outside) && (React.createElement("span", { className: (0, react_styles_1.css)(progress_1.default.progressMeasure) }, label || `${value}%`)),
            StatusIcon && (React.createElement("span", { className: (0, react_styles_1.css)(progress_1.default.progressStatusIcon) },
        ...
        helperText && React.createElement(ProgressHelperText_1.ProgressHelperText, null, helperText)));
};
