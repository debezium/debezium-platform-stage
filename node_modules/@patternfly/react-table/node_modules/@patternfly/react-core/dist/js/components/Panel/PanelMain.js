...
const c_panel__main_MaxHeight_1 = tslib_1.__importDefault(require('@patternfly/react-tokens/dist/js/c_panel__main_MaxHeight'));
const PanelMain = (_a) => {
    var { className, children, maxHeight } = _a, props = tslib_1.__rest(_a, ["className", "children", "maxHeight"]);
    return (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(panel_1.default.panelMain, className), style: { [c_panel__main_MaxHeight_1.default.name]: maxHeight } }, props), children));
};
