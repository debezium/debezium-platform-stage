            ...
            React.createElement(Component, Object.assign({ "aria-label": ariaLabel, className: (0, react_styles_1.css)(tabs_1.default.tabs, isFilled && tabs_1.default.modifiers.fill, isSubtab && tabs_1.default.modifiers.subtab, isVertical && tabs_1.default.modifiers.vertical, isVertical && expandable && (0, util_1.formatBreakpointMods)(expandable, tabs_1.default), isVertical && expandable && isExpandedLocal && tabs_1.default.modifiers.expanded, isBox && tabs_1.default.modifiers.box, showScrollButtons && tabs_1.default.modifiers.scrollable, usePageInsets && tabs_1.default.modifiers.pageInsets, hasNoBorderBottom && tabs_1.default.modifiers.noBorderBottom, (0, util_1.formatBreakpointMods)(inset, tabs_1.default), variantStyle[variant], hasOverflowTab && tabs_1.default.modifiers.overflow, className) }, (0, helpers_1.getOUIAProps)(Tabs.displayName, ouiaId !== undefined ? ouiaId : this.state.ouiaStateId, ouiaSafe), { id: id && id }, props),
                expandable && isVertical && (React.createElement(GenerateId_1.GenerateId, null, (randomId) => (React.createElement("div", { className: (0, react_styles_1.css)(tabs_1.default.tabsToggle) },
                    React.createElement("div", { className: (0, react_styles_1.css)(tabs_1.default.tabsToggleButton) },
                        React.createElement(Button_1.Button, { onClick: (event) => toggleTabs(event, !isExpandedLocal), variant: "plain", "aria-label": toggleAriaLabel, "aria-expanded": isExpandedLocal, id: `${randomId}-button`, "aria-labelledby": `${randomId}-text ${randomId}-button`, icon: React.createElement("span", { className: (0, react_styles_1.css)(tabs_1.default.tabsToggleIcon) },
                                React.createElement(angle_right_icon_1.default, null)) }, toggleText && React.createElement("span", { id: `${randomId}-text` }, toggleText))))))),
                renderScrollButtons && (React.createElement("div", { className: (0, react_styles_1.css)(tabs_1.default.tabsScrollButton) },
                    React.createElement(Button_1.Button, { "aria-label": backScrollAriaLabel || leftScrollAriaLabel, onClick: this.scrollBack, isDisabled: disableBackScrollButton, "aria-hidden": disableBackScrollButton, ref: this.leftScrollButtonRef, variant: "plain", icon: React.createElement(angle_left_icon_1.default, null) }))),
                ...
                renderScrollButtons && (React.createElement("div", { className: (0, react_styles_1.css)(tabs_1.default.tabsScrollButton) },
                    React.createElement(Button_1.Button, { "aria-label": forwardScrollAriaLabel || rightScrollAriaLabel, onClick: this.scrollForward, isDisabled: disableForwardScrollButton, "aria-hidden": disableForwardScrollButton, variant: "plain", icon: React.createElement(angle_right_icon_1.default, null) }))),
                onAdd !== undefined && (React.createElement("span", { className: (0, react_styles_1.css)(tabs_1.default.tabsAdd) },
                    React.createElement(Button_1.Button, { variant: "plain", "aria-label": addButtonAriaLabel || 'Add tab', onClick: onAdd, icon: React.createElement(plus_icon_1.default, null) })))),
            filteredChildren
