...
const AboutModalBoxCloseButton = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(about_modal_box_1.default.aboutModalBoxClose) }, props),
        React.createElement(Button_1.Button, { variant: "plain", onClick: onClose, "aria-label": ariaLabel, icon: React.createElement(times_icon_1.default, null) })));
};
