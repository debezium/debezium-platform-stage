...
const AboutModalBoxBrand = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(about_modal_box_1.default.aboutModalBoxBrand) }, props),
        React.createElement("img", { className: (0, react_styles_1.css)(about_modal_box_1.default.aboutModalBoxBrandImage), src: src, alt: alt })));
};
