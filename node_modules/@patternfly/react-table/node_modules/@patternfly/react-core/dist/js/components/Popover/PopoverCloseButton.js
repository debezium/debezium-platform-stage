...
const PopoverCloseButton = (_a) => {
    ...
    return (React.createElement("div", { className: (0, react_styles_1.css)(popover_1.default.popoverClose) },
        React.createElement(Button_1.Button, Object.assign({ onClick: onClose, variant: "plain", "aria-label": true }, props, { style: { pointerEvents: 'auto' }, icon: React.createElement(times_icon_1.default, null) }))));
};
