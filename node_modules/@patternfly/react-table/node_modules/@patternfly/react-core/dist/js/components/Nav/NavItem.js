...
const NavItem = (_a) => {
    ...
    const { flyoutRef, setFlyoutRef, navRef } = React.useContext(Nav_1.NavContext);
    const { isSidebarOpen } = React.useContext(PageSidebar_1.PageSidebarContext);
    ...
    const renderDefaultLink = (context) => {
        ...
        return (React.createElement(Component, Object.assign({ href: to, onClick: (e) => context.onSelect(e, groupId, itemId, to, preventLinkDefault, onClick), className: (0, react_styles_1.css)(nav_1.default.navLink, isActive && nav_1.default.modifiers.current, isHovered && nav_1.default.modifiers.hover, className), "aria-current": isActive ? 'page' : null, tabIndex: tabIndex }, (hasFlyout && Object.assign({}, ariaFlyoutProps)), props),
            icon && React.createElement("span", { className: (0, react_styles_1.css)(nav_1.default.navLinkIcon) }, icon),
            React.createElement("span", { className: (0, react_styles_1.css)(`${nav_1.default.nav}__link-text`) }, children),
            flyout && flyoutButton));
    };
    ...
    const flyoutPopper = (React.createElement(Popper_1.Popper, { triggerRef: ref, popper: React.createElement("div", { ref: popperRef, onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave }, flyout), popperRef: popperRef, placement: "right-start", isVisible: flyoutVisible, onDocumentKeyDown: handleFlyout, zIndex: zIndex, appendTo: navRef === null || navRef === void 0 ? void 0 : navRef.current }));
