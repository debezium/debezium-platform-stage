...
const Label = (_a) => {
    ...
    const defaultCloseButton = (React.createElement(Button_1.Button, Object.assign({ type: "button", variant: "plain", hasNoPadding: true, onClick: onClose, "aria-label": closeBtnAriaLabel || `Close ${children}` }, (isClickableDisabled && { isDisabled: true }), closeBtnProps, { icon: React.createElement(times_icon_1.default, null) })));
    const closeButton = React.createElement("span", { className: (0, react_styles_1.css)(label_1.default.labelActions) }, closeBtn || defaultCloseButton);
    ...
    const content = (React.createElement(React.Fragment, null,
        _icon && React.createElement("span", { className: (0, react_styles_1.css)(label_1.default.labelIcon) }, _icon),
