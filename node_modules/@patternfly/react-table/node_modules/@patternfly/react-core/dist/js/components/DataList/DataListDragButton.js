...
const DataListDragButton = (_a) => {
    ...
    return (React.createElement("button", Object.assign({ className: (0, react_styles_1.css)(data_list_1.default.dataListItemDraggableButton, isDisabled && data_list_1.default.modifiers.disabled, className), type: "button", disabled: isDisabled }, props),
        React.createElement("span", { className: (0, react_styles_1.css)(data_list_1.default.dataListItemDraggableIcon) },
