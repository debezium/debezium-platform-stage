...
const SearchInputBase = (_a) => {
    ...
    const buildTextInputGroup = (_a = {}) => {
        ...
        return (React.createElement(TextInputGroup_1.TextInputGroup, Object.assign({ isDisabled: isDisabled }, searchInputProps),
            React.createElement(TextInputGroup_1.TextInputGroupMain, { hint: hint, icon: React.createElement(search_icon_1.default, null), innerRef: searchInputInputRef, value: searchValue, placeholder: placeholder, "aria-label": ariaLabel, onKeyDown: onEnter, onChange: onChangeHandler, name: name, inputId: searchInputId }),
            (renderUtilities || areUtilitiesDisplayed) && (React.createElement(TextInputGroup_1.TextInputGroupUtilities, null,
                resultsCount && React.createElement(Badge_1.Badge, { isRead: true }, resultsCount),
                !!onNextClick && !!onPreviousClick && (React.createElement("div", { className: text_input_group_1.default.textInputGroupGroup },
                    React.createElement(Button_1.Button, { variant: Button_1.ButtonVariant.plain, "aria-label": previousNavigationButtonAriaLabel, isDisabled: isDisabled || isPreviousNavigationButtonDisabled, onClick: onPreviousClick, icon: React.createElement(angle_up_icon_1.default, null) }),
                    React.createElement(Button_1.Button, { variant: Button_1.ButtonVariant.plain, "aria-label": nextNavigationButtonAriaLabel, isDisabled: isDisabled || isNextNavigationButtonDisabled, onClick: onNextClick, icon: React.createElement(angle_down_icon_1.default, null) }))),
                !!onClear && !expandableInput && (React.createElement(Button_1.Button, { variant: Button_1.ButtonVariant.plain, isDisabled: isDisabled, "aria-label": resetButtonLabel, onClick: onClearInput, icon: React.createElement(times_icon_1.default, null) }))))));
    };
    ...
    const buildExpandableSearchInput = (_a = {}) => {
        ...
        return (React.createElement(InputGroup_1.InputGroup, Object.assign({}, searchInputProps),
            React.createElement(InputGroup_1.InputGroupItem, { isFill: true },
                buildTextInputGroup(),
                " "),
            React.createElement(InputGroup_1.InputGroupItem, { isPlain: true }, expandableToggle)));
    };
    ...
    const buildSearchTextInputGroupWithExtraButtons = (_a = {}) => {
        var searchInputProps = tslib_1.__rest(_a, []);
        return (React.createElement(InputGroup_1.InputGroup, Object.assign({ ref: triggerRef }, searchInputProps),
            React.createElement(InputGroup_1.InputGroupItem, { isFill: true }, buildTextInputGroup()),
            (attributes.length > 0 || onToggleAdvancedSearch) && (React.createElement(InputGroup_1.InputGroupItem, { isPlain: true },
                React.createElement(Button_1.Button, { className: isSearchMenuOpen && 'pf-m-expanded', variant: Button_1.ButtonVariant.control, "aria-label": openMenuButtonAriaLabel, onClick: onToggle, isDisabled: isDisabled, "aria-expanded": isSearchMenuOpen, icon: React.createElement(caret_down_icon_1.default, null) }))),
            !!onSearch && (React.createElement(InputGroup_1.InputGroupItem, null,
                React.createElement(Button_1.Button, { type: "submit", variant: Button_1.ButtonVariant.control, "aria-label": submitSearchButtonLabel, onClick: onSearchHandler, isDisabled: isDisabled, icon: React.createElement(Icon_1.Icon, { shouldMirrorRTL: true },
                        React.createElement(arrow_right_icon_1.default, null)) }))),
            expandableInput && React.createElement(InputGroup_1.InputGroupItem, null, expandableToggle)));
    };
    ...
    if (!!expandableInput && !isExpanded) {
        return (React.createElement(InputGroup_1.InputGroup, Object.assign({}, searchInputProps),
            React.createElement(InputGroup_1.InputGroupItem, null, expandableToggle)));
    }
    if (!!onSearch || attributes.length > 0 || !!onToggleAdvancedSearch) {
        if (attributes.length > 0) {
            ...
            const AdvancedSearchWithPopper = (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(className), ref: searchInputRef }, props),
                React.createElement(helpers_1.Popper, { trigger: buildSearchTextInputGroupWithExtraButtons(), triggerRef: triggerRef, popper: AdvancedSearch, popperRef: popperRef, isVisible: isSearchMenuOpen, enableFlip: true, appendTo: () => appendTo || searchInputRef.current, zIndex: zIndex })));
