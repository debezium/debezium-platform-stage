...
const NavGroup = (_a) => {
    ...
    return (React.createElement("section", Object.assign({ className: (0, react_styles_1.css)(nav_1.default.navSection, className), "aria-labelledby": labelledBy }, props),
        title && (React.createElement("h2", { className: (0, react_styles_1.css)(nav_1.default.navSectionTitle), id: id }, title)),
        React.createElement("ul", { className: (0, react_styles_1.css)(nav_1.default.navList, className), role: "list" }, children)));
};
