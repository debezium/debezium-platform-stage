...
export declare enum ToolbarColorVariant {
    default = "default",
    primary = "primary",
    secondary = "secondary",
...
declare class Toolbar extends React.Component<ToolbarProps, ToolbarState> {
    static displayName: string;
    labelGroupContentRef: React.RefObject<HTMLDivElement>;
    staticFilterInfo: {};
    state: {
        isManagedToggleExpanded: boolean;
        filterInfo: {};
    ...
    renderToolbar: (randomId: string) => React.JSX.Element;
