...
const DualListSelectorListItemBase = (_a) => {
    ...
    return (React.createElement("li", Object.assign({ className: (0, react_styles_1.css)(dual_list_selector_1.default.dualListSelectorListItem, className, isDisabled && dual_list_selector_1.default.modifiers.disabled), key: orderIndex, onClick: isDisabled
            ? undefined
            : (e) => {
                setFocusedOption(id);
                onOptionSelect(e, id);
        ...
        React.createElement("div", { className: (0, react_styles_1.css)(dual_list_selector_1.default.dualListSelectorListItemRow, isSelected && dual_list_selector_1.default.modifiers.selected) },
            isDraggable && !isDisabled && (React.createElement("div", { className: (0, react_styles_1.css)(dual_list_selector_1.default.dualListSelectorDraggable) },
                React.createElement(Button_1.Button, { variant: Button_1.ButtonVariant.plain, component: "span", icon: React.createElement(grip_vertical_icon_1.default, { style: { verticalAlign: '-0.3em' } }) }))),
            React.createElement("span", { className: (0, react_styles_1.css)(dual_list_selector_1.default.dualListSelectorItem) },
                React.createElement("span", { className: (0, react_styles_1.css)(dual_list_selector_1.default.dualListSelectorItemMain) },
                    React.createElement("span", { className: (0, react_styles_1.css)(dual_list_selector_1.default.dualListSelectorItemText) }, children))))));
};
