...
const OverflowMenuControl = (_a) => {
    ...
    return (React.createElement(OverflowMenuContext_1.OverflowMenuContext.Consumer, null, (value) => (value.isBelowBreakpoint || hasAdditionalOptions) && (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(overflow_menu_1.default.overflowMenuControl, className) }, props),
        ' ',
        children,
        ' '))));
};
