...
const JumpLinksItem = (_a) => {
    ...
    return (React.createElement("li", Object.assign({ className: (0, react_styles_1.css)(jump_links_1.default.jumpLinksItem, isActive && jump_links_1.default.modifiers.current, className) }, (isActive && { 'aria-current': 'location' }), props),
        React.createElement("span", { className: jump_links_1.default.jumpLinksLink },
            React.createElement(Button_1.Button, { variant: Button_1.ButtonVariant.link, component: "a", href: href, onClick: onClick },
