    ...
    return (React.createElement("div", Object.assign({ 
        ...
        React.createElement(InputGroup_1.InputGroup, null,
            React.createElement(InputGroup_1.InputGroupItem, null,
                React.createElement(Button_1.Button, Object.assign({ variant: "control", "aria-label": minusBtnAriaLabel, isDisabled: isDisabled || (typeof value === 'number' ? value : DEFAULT_VALUE) <= min, onClick: (evt) => onMinus(evt, inputName) }, minusBtnProps),
            ...
            React.createElement(InputGroup_1.InputGroupItem, null,
                React.createElement(TextInput_1.TextInput, Object.assign({}, inputProps, { type: "number", value: value, name: inputName, "aria-label": inputAriaLabel }, (isDisabled && { isDisabled }), (onChange && { onChange: (event, _value) => onChange(event) }), { onBlur: handleBlur }, (!onChange && { readOnlyVariant: 'default' }), { onKeyDown: keyDownHandler, validated: validated }))),
            React.createElement(InputGroup_1.InputGroupItem, null,
                React.createElement(Button_1.Button, Object.assign({ variant: "control", "aria-label": plusBtnAriaLabel, isDisabled: isDisabled || (typeof value === 'number' ? value : DEFAULT_VALUE) >= max, onClick: (evt) => onPlus(evt, inputName) }, plusBtnProps),
                    React.createElement("span", { className: (0, react_styles_1.css)(number_input_1.default.numberInputIcon) },
