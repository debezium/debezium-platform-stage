...
const DescriptionListDescription = (_a) => {
    ...
    return (React.createElement("dd", Object.assign({ className: (0, react_styles_1.css)(description_list_1.default.descriptionListDescription, className) }, props),
        React.createElement("div", { className: (0, react_styles_1.css)(description_list_1.default.descriptionListText) }, children)));
};
