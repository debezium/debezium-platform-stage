...
const Masthead = (_a) => {
    ...
    return (React.createElement("header", Object.assign({ className: (0, react_styles_1.css)(masthead_1.default.masthead, (0, util_1.formatBreakpointMods)(display, masthead_1.default, 'display-', getBreakpoint(width)), (0, util_1.formatBreakpointMods)(inset, masthead_1.default, '', getBreakpoint(width)), className) }, props), children));
};
