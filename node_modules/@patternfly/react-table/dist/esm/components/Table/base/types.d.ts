...
import { IActions, ISortBy, OnCheckChange, OnCollapse, OnExpand, OnFavorite, OnSelect, OnSort, OnToggleRowDetails, OnTreeRowCollapse } from '../TableTypes';
...
export declare const TableDefaults: {
    renderers: {
        table: React.ForwardRefExoticComponent<Omit<import("../Table").TableProps, "ref"> & React.RefAttributes<HTMLTableElement>>;
        header: {
            wrapper: React.ForwardRefExoticComponent<Omit<import("../Thead").TheadProps, "ref"> & React.RefAttributes<HTMLTableSectionElement>>;
            row: React.ForwardRefExoticComponent<Omit<import("../Tr").TrProps, "ref"> & React.RefAttributes<HTMLTableRowElement>>;
            cell: React.ForwardRefExoticComponent<Omit<import("../Th").ThProps, "ref"> & React.RefAttributes<HTMLTableHeaderCellElement>>;
        };
        body: {
            wrapper: React.ForwardRefExoticComponent<Omit<import("../Tbody").TbodyProps, "ref"> & React.RefAttributes<HTMLTableSectionElement>>;
            row: React.ForwardRefExoticComponent<Omit<import("../Tr").TrProps, "ref"> & React.RefAttributes<HTMLTableRowElement>>;
            cell: React.ForwardRefExoticComponent<Omit<import("../Td").TdProps, "ref"> & React.RefAttributes<HTMLTableDataCellElement>>;
        };
    };
};
