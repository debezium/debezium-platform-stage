...
const columns_are_equal_1 = require("../../../../components/Table/base/columns-are-equal");
...
class BodyRow extends React.Component {
    shouldComponentUpdate(nextProps) {
        ...
        return !((0, columns_are_equal_1.columnsAreEqual)(columns, nextProps.columns) && (0, isEqual_1.default)(rowData, nextProps.rowData));
    }
    render() {
        ...
        return React.createElement(renderers.row, onRow(rowData, { rowIndex, rowKey }), columns.map((column, columnIndex) => {
            ...
            const transformed = (0, evaluate_transforms_1.evaluateTransforms)(transforms, rowData[evaluatedProperty], extraParameters);
            if (!transformed) {
            ...
            return React.createElement(renderers.cell, Object.assign({ key: `col-${columnIndex}-row-${rowIndex}` }, (0, merge_props_1.mergeProps)(props, cell && cell.props, transformed)), (!rowData.fullWidth && transformed.children) ||
                (0, evaluate_formatters_1.evaluateFormatters)([...formatters, ...additionalFormaters])(rowData[`_${evaluatedProperty}`] || rowData[evaluatedProperty], extraParameters));
        }));
    }
}
