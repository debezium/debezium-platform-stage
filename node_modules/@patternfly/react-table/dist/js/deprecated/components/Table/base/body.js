...
const Body = (props) => (React.createElement(provider_1.ProviderContext.Consumer, null, ({ columns, renderers }) => React.createElement(BaseBody, Object.assign({ columns: columns, renderers: renderers }, props))));
exports.Body = Body;
