...
const FavoritesCell = (_a) => {
    ...
    return (React.createElement(Button_1.Button, Object.assign({ variant: "plain", className: className, type: "button", "aria-label": isFavorited ? 'Starred' : 'Not starred', onClick: onFavorite }, ariaProps, props, { icon: React.createElement(star_icon_1.default, { "aria-hidden": true }) })));
};
