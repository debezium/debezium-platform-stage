...
exports.DraggableRowWrapper = void 0;
...
const DraggableRowWrapper = (_a) => {
    ...
    return (React.createElement(Tr_1.Tr, Object.assign({ "aria-level": level, "aria-posinset": posinset, "aria-setsize": setsize, "aria-expanded": !!isExpanded, isHidden: isHidden, className: (0, react_styles_1.css)(className, isExpanded && table_1.default.modifiers.expanded, isDetailsExpanded && table_tree_view_1.default.modifiers.treeViewDetailsExpanded) }, props)));
};
exports.DraggableRowWrapper = DraggableRowWrapper;
exports.DraggableRowWrapper.displayName = 'DraggableRowWrapper';
//# sourceMappingURL=DraggableRowWrapper.js.map