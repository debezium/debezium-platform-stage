...
class RowWrapper extends React.Component {
    constructor(props) {
        ...
        if (props.onScroll) {
            this.handleScroll = (0, util_1.debounce)(this.handleScroll, 100);
        }
        if (props.onResize) {
            this.handleResize = (0, util_1.debounce)(this.handleResize, 100);
        }
    }
    componentDidMount() {
    ...
    render() {
        ...
        return (React.createElement(Tr_1.Tr, Object.assign({}, props, { ref: trRef, isExpanded: isExpanded, isEditable: isEditable, className: className, ouiaId: ouiaId, isClickable: isClickable, isRowSelected: isRowSelected })));
    }
}
