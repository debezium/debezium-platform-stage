...
const sortableFavorites = (sort) => () => (0, exports.sortable)(React.createElement(star_icon_1.default, { "aria-hidden": true }), {
...
const sortable = (label, { columnIndex, column, property, className, ariaLabel, tooltip, tooltipProps, tooltipHasDefaultBehavior }) => {
    ...
    return {
        className: (0, react_styles_1.css)(table_1.default.tableSort, isSortedBy && table_1.default.modifiers.selected, className),
        'aria-sort': isSortedBy ? `${sortBy.direction}ending` : 'none',
        children: (React.createElement(SortColumn_1.SortColumn, { isSortedBy: isSortedBy, sortDirection: isSortedBy ? sortBy.direction : '', onSort: sortClicked, "aria-label": ariaLabel, tooltip: tooltip, tooltipProps: tooltipProps, tooltipHasDefaultBehavior: tooltipHasDefaultBehavior }, label))
    };
};
