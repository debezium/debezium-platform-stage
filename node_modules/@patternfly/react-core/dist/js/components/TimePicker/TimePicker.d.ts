...
export interface TimePickerProps extends Omit<React.HTMLProps<HTMLDivElement>, 'onChange' | 'onFocus' | 'onBlur' | 'disabled' | 'ref'> {
    ...
    onChange?: (event: React.FormEvent<HTMLInputElement>, time: string, hour?: number, minute?: number, seconds?: number, isValid?: boolean) => void;
...
declare class TimePicker extends React.Component<TimePickerProps, TimePickerState> {
    ...
    onInputChange: (event: React.FormEvent<HTMLInputElement>, newTime: string) => void;
