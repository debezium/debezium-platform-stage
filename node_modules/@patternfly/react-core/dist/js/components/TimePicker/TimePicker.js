...
const outlined_clock_icon_1 = tslib_1.__importDefault(require('@patternfly/react-icons/dist/js/icons/outlined-clock-icon'));
const c_date_picker__input_c_form_control_Width_1 = tslib_1.__importDefault(require('@patternfly/react-tokens/dist/js/c_date_picker__input_c_form_control_Width'));
class TimePicker extends React.Component {
    constructor(props) {
        ...
        this.scrollToIndex = (index) => {
            this.getOptions()[index].closest(`.${menu_1.default.menuContent}`).scrollTop =
        ...
        this.scrollToSelection = (time) => {
            ...
            if (splitTime.length < 2) {
                ...
                time = (0, TimePickerUtils_1.parseTime)(time, this.state.timeRegex, delimiter, !is24Hour, false);
                splitTime = time.split(delimiter);
            }
        ...
        this.isValidFormat = (time) => {
            ...
            return (0, TimePickerUtils_1.validateTime)(time, this.getRegExp(includeSeconds), delimiter, !is24Hour);
        };
        this.isValidTime = (time) => {
            const { delimiter, includeSeconds } = this.props;
            const { minTimeState, maxTimeState } = this.state;
            return (0, TimePickerUtils_1.isWithinMinMax)(minTimeState, maxTimeState, time, delimiter, includeSeconds);
        };
        ...
        this.onToggle = (isOpen) => {
            ...
            this.setState((prevState) => {
                ...
                const time = (0, TimePickerUtils_1.parseTime)(timeState, timeRegex, delimiter, !is24Hour, includeSeconds);
                // Call onChange when Enter is pressed in input and timeoption does not exist in menu
                if (onChange && !isOpen && time !== timeState) {
                    onChange(null, time, (0, TimePickerUtils_1.getHours)(time, timeRegex), (0, TimePickerUtils_1.getMinutes)(time, timeRegex), (0, TimePickerUtils_1.getSeconds)(time, timeRegex), this.isValid(time));
                }
                return {
        ...
        this.onSelect = (e) => {
            ...
            const time = (0, TimePickerUtils_1.parseTime)(e.target.textContent, timeRegex, delimiter, !is24Hour, includeSeconds);
            if (time !== timeState) {
        ...
        this.onInputChange = (event, newTime) => {
            ...
            if (onChange) {
                onChange(event, newTime, (0, TimePickerUtils_1.getHours)(newTime, timeRegex), (0, TimePickerUtils_1.getMinutes)(newTime, timeRegex), (0, TimePickerUtils_1.getSeconds)(newTime, timeRegex), this.isValid(newTime));
            }
        ...
        this.state = {
            isInvalid: false,
            isTimeOptionsOpen: isOpen,
            timeState: (0, TimePickerUtils_1.parseTime)(time, timeRegex, delimiter, !is24Hour, includeSeconds),
            focusedIndex: null,
            scrollIndex: 0,
            timeRegex,
            minTimeState: (0, TimePickerUtils_1.parseTime)(minTime, timeRegex, delimiter, !is24Hour, includeSeconds),
            maxTimeState: (0, TimePickerUtils_1.parseTime)(maxTime, timeRegex, delimiter, !is24Hour, includeSeconds)
        };
    }
    componentDidMount() {
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (time !== '' && time !== prevProps.time) {
            const parsedTime = (0, TimePickerUtils_1.parseTime)(time, timeRegex, delimiter, !is24Hour, includeSeconds);
            this.setState({
    ...
    render() {
        ...
        setIsOpen, 
        /* eslint-disable @typescript-eslint/no-unused-vars */
        isOpen, time, validateTime, minTime, maxTime, includeSeconds, zIndex } = _a, props = tslib_1.__rest(_a, ['aria-label', "isDisabled", "className", "placeholder", "id", "menuAppendTo", "is24Hour", "invalidFormatErrorMessage", "invalidMinMaxErrorMessage", "stepMinutes", "width", "delimiter", "inputProps", "onChange", "setIsOpen", "isOpen", "time", "validateTime", "minTime", "maxTime", "includeSeconds", "zIndex"]);
        const { timeState, isTimeOptionsOpen, isInvalid, minTimeState, maxTimeState } = this.state;
        const style = { [c_date_picker__input_c_form_control_Width_1.default.name]: width };
        const options = (0, TimePickerUtils_1.makeTimeOptions)(stepMinutes, !is24Hour, delimiter, minTimeState, maxTimeState, includeSeconds);
        const isValidFormat = this.isValidFormat(timeState);
        const randomId = id || (0, helpers_1.getUniqueId)('time-picker');
        ...
        const textInput = (React.createElement(TextInput_1.TextInput, Object.assign({ "aria-haspopup": "menu", id: `${randomId}-input`, "aria-label": ariaLabel, validated: isInvalid ? 'error' : 'default', placeholder: placeholder, value: timeState || '', type: "text", customIcon: React.createElement(outlined_clock_icon_1.default, null), onClick: this.onInputClick, onChange: this.onInputChange, autoComplete: "off", isDisabled: isDisabled, isExpanded: isTimeOptionsOpen, ref: this.inputRef }, inputProps)));
        ...
        return (React.createElement("div", { ref: this.baseComponentRef, className: (0, react_styles_1.css)(date_picker_1.default.datePicker, className) },
            React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(date_picker_1.default.datePickerInput), style: style }, props),
                    ...
                    React.createElement(InputGroup_1.InputGroupItem, null,
                        React.createElement("div", { id: randomId },
                            React.createElement("div", { ref: this.toggleRef, style: { paddingLeft: '0' } },
                                React.createElement(Popper_1.Popper, { appendTo: calculatedAppendTo, trigger: textInput, triggerRef: this.toggleRef, popper: menuContainer, popperRef: this.menuRef, isVisible: isTimeOptionsOpen, zIndex: zIndex }))))),
                isInvalid && (React.createElement("div", { className: (0, react_styles_1.css)(date_picker_1.default.datePickerHelperText) },
                    React.createElement(HelperText_1.HelperText, null,
                        React.createElement(HelperText_1.HelperTextItem, { variant: "error" }, !isValidFormat ? invalidFormatErrorMessage : invalidMinMaxErrorMessage)))))));
    }
}
