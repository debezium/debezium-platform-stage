...
const TabContentBase = (_a) => {
    ...
    if (children || child) {
        ...
        return (React.createElement(TabsContext_1.TabsContextConsumer, null, ({ variant }) => {
