...
const DualListSelectorControlsWrapperBase = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(dual_list_selector_1.default.dualListSelectorControls, className), tabIndex: 0, ref: wrapperRef, "aria-label": ariaLabel }, props), children));
};
...
exports.DualListSelectorControlsWrapper = React.forwardRef((props, ref) => (React.createElement(exports.DualListSelectorControlsWrapperBase, Object.assign({ innerRef: ref, role: "group" }, props))));
