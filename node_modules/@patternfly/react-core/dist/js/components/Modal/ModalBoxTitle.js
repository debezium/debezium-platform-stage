...
const ModalBoxTitle = (_a) => {
    var { className, id, title, titleIconVariant, titleScreenReaderText } = _a, props = tslib_1.__rest(_a, ["className", "id", "title", "titleIconVariant", "titleScreenReaderText"]);
    const [hasTooltip, setHasTooltip] = React.useState(false);
    const h1 = React.useRef(null);
    const label = titleScreenReaderText ||
        ((0, exports.isVariantIcon)(titleIconVariant) ? `${(0, helpers_1.capitalize)(titleIconVariant)} alert:` : titleScreenReaderText);
    const variantIcons = {
        ...
        custom: React.createElement(bell_icon_1.default, null)
    };
    ...
    const content = (React.createElement("h1", Object.assign({ id: id, ref: h1, className: (0, react_styles_1.css)(modal_box_1.default.modalBoxTitle, titleIconVariant && modal_box_1.default.modifiers.icon, (0, exports.isVariantIcon)(titleIconVariant) && modal_box_1.default.modifiers[titleIconVariant], className) }, props),
        titleIconVariant && (React.createElement("span", { className: (0, react_styles_1.css)(modal_box_1.default.modalBoxTitleIcon) }, (0, exports.isVariantIcon)(titleIconVariant) ? variantIcons[titleIconVariant] : React.createElement(CustomIcon, null))),
        label && React.createElement("span", { className: "pf-v6-screen-reader" }, label),
        React.createElement("span", { className: (0, react_styles_1.css)(modal_box_1.default.modalBoxTitleText) }, title)));
