...
const Sidebar = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(sidebar_1.default.sidebar, hasGutter && sidebar_1.default.modifiers.gutter, hasNoBackground && sidebar_1.default.modifiers.noBackground, isPanelRight && sidebar_1.default.modifiers.panelRight, sidebar_1.default.modifiers[orientation], className) }, props),
        React.createElement("div", { className: (0, react_styles_1.css)(sidebar_1.default.sidebarMain, hasBorder && sidebar_1.default.modifiers.border) }, children)));
};
