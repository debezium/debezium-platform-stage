...
const FormFieldGroupToggle = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(form_1.default.formFieldGroupToggle, className) }, props),
        React.createElement("div", { className: (0, react_styles_1.css)(form_1.default.formFieldGroupToggleButton) },
            React.createElement(Button_1.Button, { variant: "plain", "aria-label": ariaLabel, onClick: onToggle, "aria-expanded": isExpanded, "aria-labelledby": ariaLabelledby, id: toggleId, icon: React.createElement("span", { className: (0, react_styles_1.css)(form_1.default.formFieldGroupToggleIcon) },
