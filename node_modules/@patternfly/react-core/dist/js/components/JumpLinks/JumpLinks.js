...
const JumpLinks = (_a) => {
    var { isCentered, isVertical, children, label, 'aria-label': ariaLabel = typeof label === 'string' ? label : null, scrollableRef, scrollableSelector, activeIndex: activeIndexProp = 0, offset = 0, expandable, isExpanded: isExpandedProp = false, alwaysShowLabel = true, toggleAriaLabel = 'Toggle jump links', className } = _a, props = tslib_1.__rest(_a, ["isCentered", "isVertical", "children", "label", 'aria-label', "scrollableRef", "scrollableSelector", "activeIndex", "offset", "expandable", "isExpanded", "alwaysShowLabel", "toggleAriaLabel", "className"]);
    ...
    return (React.createElement("nav", Object.assign({ className: (0, react_styles_1.css)(jump_links_1.default.jumpLinks, isCentered && jump_links_1.default.modifiers.center, isVertical && jump_links_1.default.modifiers.vertical, (0, util_1.formatBreakpointMods)(expandable, jump_links_1.default), isExpanded && jump_links_1.default.modifiers.expanded, className), "aria-label": ariaLabel, ref: navRef }, props),
        React.createElement("div", { className: jump_links_1.default.jumpLinksMain },
            React.createElement("div", { className: (0, react_styles_1.css)(`${jump_links_1.default.jumpLinks}__header`) },
                expandable && (React.createElement("div", { className: jump_links_1.default.jumpLinksToggle },
                    React.createElement(Button_1.Button, { variant: "plain", onClick: () => setIsExpanded(!isExpanded), "aria-label": toggleAriaLabel, "aria-expanded": isExpanded, icon: React.createElement("span", { className: jump_links_1.default.jumpLinksToggleIcon },
                            React.createElement(angle_right_icon_1.default, null)) }, label && label))),
                label && alwaysShowLabel && React.createElement("div", { className: (0, react_styles_1.css)(jump_links_1.default.jumpLinksLabel) }, label)),
            React.createElement("ul", { className: jump_links_1.default.jumpLinksList, role: "list" }, cloneChildren(children)))));
};
