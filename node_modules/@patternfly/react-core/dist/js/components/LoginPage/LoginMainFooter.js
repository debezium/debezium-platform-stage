...
const LoginMainFooter = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(login_1.default.loginMainFooter, className) }, props),
        children,
        socialMediaLoginContent && (React.createElement("ul", { className: (0, react_styles_1.css)(login_1.default.loginMainFooterLinks), "aria-label": socialMediaLoginAriaLabel, role: "list" }, socialMediaLoginContent)),
        (signUpForAccountMessage || forgotCredentials) && (React.createElement("div", { className: (0, react_styles_1.css)(login_1.default.loginMainFooterBand) },
