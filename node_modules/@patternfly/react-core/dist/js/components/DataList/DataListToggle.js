...
const DataListToggle = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(data_list_1.default.dataListItemControl, className) }, props),
        React.createElement("div", { className: (0, react_styles_1.css)(data_list_1.default.dataListToggle) },
            React.createElement(Button_1.Button, Object.assign({ id: id, variant: Button_1.ButtonVariant.plain, "aria-controls": ariaControls !== '' && ariaControls, "aria-label": ariaLabel, "aria-labelledby": ariaLabel !== 'Details' ? null : `${rowid} ${id}`, "aria-expanded": isExpanded }, buttonProps, { icon: React.createElement("div", { className: (0, react_styles_1.css)(data_list_1.default.dataListToggleIcon) },
