...
const TextList = (_a) => {
    ...
    return (React.createElement(Component, Object.assign({}, props, { className: (0, react_styles_1.css)(isPlain && content_1.default.modifiers.plain, componentStyles[component], className) }), children));
};
