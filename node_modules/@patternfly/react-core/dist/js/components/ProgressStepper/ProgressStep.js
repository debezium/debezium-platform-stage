...
const ProgressStep = (_a) => {
    ...
    return (React.createElement("li", Object.assign({ className: (0, react_styles_1.css)(progress_stepper_1.default.progressStepperStep, variantStyle[variant], isCurrent && progress_stepper_1.default.modifiers.current, className), "aria-label": ariaLabel, 
        // CSS style `display: contents` gives this li a generic role, we need to override that
        role: "listitem" }, (isCurrent && { 'aria-current': 'step' }), props),
        React.createElement("div", { className: (0, react_styles_1.css)(progress_stepper_1.default.progressStepperStepConnector) },
            React.createElement("span", { className: (0, react_styles_1.css)(progress_stepper_1.default.progressStepperStepIcon) }, _icon && _icon)),
        React.createElement("div", { className: (0, react_styles_1.css)(progress_stepper_1.default.progressStepperStepMain) },
            React.createElement(Component, Object.assign({ className: (0, react_styles_1.css)(progress_stepper_1.default.progressStepperStepTitle, popoverRender && progress_stepper_1.default.modifiers.helpText), id: titleId, ref: stepRef }, (popoverRender && { type: 'button' }), (props.id !== undefined &&
                titleId !== undefined &&
                popoverRender && { 'aria-labelledby': `${props.id} ${titleId}` })),
                children,
                popoverRender && popoverRender(stepRef)),
            description && React.createElement("div", { className: (0, react_styles_1.css)(progress_stepper_1.default.progressStepperStepDescription) }, description))));
};
