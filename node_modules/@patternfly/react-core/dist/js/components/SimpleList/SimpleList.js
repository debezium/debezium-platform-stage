...
class SimpleList extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(exports.SimpleListContext.Provider, { value: {
            ...
            React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(simple_list_1.default.simpleList, className) }, props),
                isGrouped && children,
                !isGrouped && (React.createElement("ul", { className: (0, react_styles_1.css)('pf-v6-c-simple-list__list'), role: "list", "aria-label": ariaLabel }, children)))));
    }
}
