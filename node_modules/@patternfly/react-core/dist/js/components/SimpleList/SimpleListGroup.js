...
const SimpleListGroup = (_a) => {
    ...
    return (React.createElement("section", Object.assign({ className: (0, react_styles_1.css)(simple_list_1.default.simpleListSection) }, props),
        React.createElement("h2", { id: id, className: (0, react_styles_1.css)(simple_list_1.default.simpleListTitle, titleClassName), "aria-hidden": "true" }, title),
        React.createElement("ul", { className: (0, react_styles_1.css)('pf-v6-c-simple-list__list', className), role: "list", "aria-labelledby": id }, children)));
};
