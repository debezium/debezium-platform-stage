...
itemsPerPageTitle = 'Items per page', perPageSuffix = 'per page', optionsToggleAriaLabel, ofWord = 'of', perPage = 0, firstIndex = 0, lastIndex = 0, isLastFullPageShown = false, itemsTitle = '', toggleTemplate, onPerPageSelect = () => null, containerRef }) => {
    ...
    return (React.createElement(Popper_1.Popper, { trigger: toggle, triggerRef: toggleRef, popper: menu, popperRef: menuRef, isVisible: isOpen, direction: dropDirection, appendTo: (containerRef === null || containerRef === void 0 ? void 0 : containerRef.current) || undefined, minWidth: minWidth !== undefined ? minWidth : 'revert' }));
};
