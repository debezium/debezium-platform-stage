...
const BackToTopBase = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(back_to_top_1.default.backToTop, !visible && back_to_top_1.default.modifiers.hidden, className), ref: innerRef, onClick: handleClick }, props),
        React.createElement(Button_1.Button, { variant: "primary", icon: React.createElement(angle_up_icon_1.default, { "aria-hidden": "true" }), iconPosition: "end" }, title)));
};
