...
useMemo }) => {
    ...
    const renderToggle = (randomId) => (react_1.default.createElement(ToggleComponent, Object.assign({ className: (0, react_styles_1.css)(tree_view_1.default.treeViewNodeToggle), onClick: (evt) => {
        ...
        react_1.default.createElement("span", { className: (0, react_styles_1.css)(tree_view_1.default.treeViewNodeToggleIcon) },
    ...
    const renderCheck = (randomId) => (react_1.default.createElement("span", { className: (0, react_styles_1.css)(tree_view_1.default.treeViewNodeCheck) },
        react_1.default.createElement("input", Object.assign({ type: "checkbox", onChange: (evt) => onCheck && onCheck(evt, itemData, parentItem), onClick: (evt) => evt.stopPropagation(), ref: (elem) => elem && (elem.indeterminate = checkProps.checked === null) }, checkProps, { checked: isCheckboxChecked, id: randomId, tabIndex: -1 }))));
    const iconRendered = (react_1.default.createElement("span", { className: (0, react_styles_1.css)(tree_view_1.default.treeViewNodeIcon) },
    ...
    const renderNodeContent = () => {
        const content = (react_1.default.createElement(react_1.default.Fragment, null,
            isCompact && title && react_1.default.createElement("span", { className: (0, react_styles_1.css)(tree_view_1.default.treeViewNodeTitle) }, title),
            isSelectable ? (react_1.default.createElement("button", { tabIndex: -1, className: (0, react_styles_1.css)(tree_view_1.default.treeViewNodeText), type: "button" }, name)) : (react_1.default.createElement("span", { className: (0, react_styles_1.css)(tree_view_1.default.treeViewNodeText) }, name))));
        return isCompact ? react_1.default.createElement("span", { className: (0, react_styles_1.css)(tree_view_1.default.treeViewNodeContent) }, content) : content;
    };
    const badgeRendered = (react_1.default.createElement(react_1.default.Fragment, null,
        hasBadge && children && (react_1.default.createElement("span", { className: (0, react_styles_1.css)(tree_view_1.default.treeViewNodeCount) },
        ...
        hasBadge && !children && customBadgeContent !== undefined && (react_1.default.createElement("span", { className: (0, react_styles_1.css)(tree_view_1.default.treeViewNodeCount) },
    ...
    return (react_1.default.createElement("li", Object.assign({ id: id, className: (0, react_styles_1.css)(tree_view_1.default.treeViewListItem, internalIsExpanded && tree_view_1.default.modifiers.expanded), "aria-expanded": internalIsExpanded, role: "treeitem", tabIndex: -1 }, (hasCheckbox && { 'aria-checked': isCheckboxChecked }), (!hasCheckbox && { 'aria-selected': isSelected })),
        react_1.default.createElement("div", { className: (0, react_styles_1.css)(tree_view_1.default.treeViewContent) },
            react_1.default.createElement(GenerateId_1.GenerateId, { prefix: isSelectable ? 'selectable-id' : 'checkbox-id' }, (randomId) => (react_1.default.createElement(Component, Object.assign({ className: (0, react_styles_1.css)(tree_view_1.default.treeViewNode, isSelected && tree_view_1.default.modifiers.current), onClick: (evt) => {
                    if (!hasCheckbox) {
                ...
                react_1.default.createElement("span", { className: (0, react_styles_1.css)(tree_view_1.default.treeViewNodeContainer) },
                    children && renderToggle(randomId),
                    hasCheckbox && renderCheck(randomId),
                    icon && iconRendered,
                    renderNodeContent(),
                    badgeRendered)))),
            action && react_1.default.createElement("div", { className: (0, react_styles_1.css)(tree_view_1.default.treeViewAction) }, action)),
