...
export const FormFieldGroupToggle = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: css(styles.formFieldGroupToggle, className) }, props),
        React.createElement("div", { className: css(styles.formFieldGroupToggleButton) },
            React.createElement(Button, { variant: "plain", "aria-label": ariaLabel, onClick: onToggle, "aria-expanded": isExpanded, "aria-labelledby": ariaLabelledby, id: toggleId, icon: React.createElement("span", { className: css(styles.formFieldGroupToggleIcon) },
