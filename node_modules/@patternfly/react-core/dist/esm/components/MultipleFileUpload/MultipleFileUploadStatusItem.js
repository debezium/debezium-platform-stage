...
export const MultipleFileUploadStatusItem = (_a) => {
    ...
    return (React.createElement("li", Object.assign({ className: css(styles.multipleFileUploadStatusItem, className) }, props),
        ...
        React.createElement("div", { className: `${styles.multipleFileUploadStatusItem}-close` },
            React.createElement(Button, { variant: "plain", "aria-label": buttonAriaLabel, onClick: onClearClick, icon: React.createElement(TimesIcon, null) }))));
};
