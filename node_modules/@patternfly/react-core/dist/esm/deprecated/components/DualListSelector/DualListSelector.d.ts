...
export interface DualListSelectorProps {
    ...
    onListChange?: (event: React.MouseEvent<HTMLElement>, newAvailableOptions: React.ReactNode[], newChosenOptions: React.ReactNode[]) => void;
    ...
    onOptionSelect?: (event: React.MouseEvent | React.ChangeEvent | React.KeyboardEvent, index: number, isChosen: boolean, id: string, itemData: any, parentData: any) => void;
    /** Optional callback fired when a dynamically built option is checked */
    onOptionCheck?: (event: React.MouseEvent | React.ChangeEvent<HTMLInputElement> | React.KeyboardEvent, checked: boolean, checkedId: string, newCheckedItems: string[]) => void;
...
declare class DualListSelector extends React.Component<DualListSelectorProps, DualListSelectorState> {
    ...
    addAllVisible: (event: React.MouseEvent<HTMLElement>) => void;
    addAllTreeVisible: (event: React.MouseEvent<HTMLElement>) => void;
    addSelected: (event: React.MouseEvent<HTMLElement>) => void;
    addTreeSelected: (event: React.MouseEvent<HTMLElement>) => void;
    removeAllVisible: (event: React.MouseEvent<HTMLElement>) => void;
    removeAllTreeVisible: (event: React.MouseEvent<HTMLElement>) => void;
    removeSelected: (event: React.MouseEvent<HTMLElement>) => void;
    removeTreeSelected: (event: React.MouseEvent<HTMLElement>) => void;
