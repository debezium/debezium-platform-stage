...
exports.c_tree_view = {
  ":where(:root, .pf-v6-c-tree-view)": {
    "c_tree_view__node_indent_base": {
      ...
      "values": [
        ...
        "calc(16px * 2 + --pf-t--global--font--size--body--default)",
        "calc(16px * 2 + --pf-t--global--font--size--sm)",
        "calc(16px * 2 + --pf-t--global--font--size--200)",
        "calc(16px * 2 + 14px)"
      ]
    },
    "c_tree_view__node_nested_indent_base": {
      "name": "--pf-v6-c-tree-view__node--nested-indent--base",
      "value": "calc(calc(16px * 2 + 14px) - 16px)",
      "values": [
        ...
        "calc(calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default) - 16px)",
        "calc(calc(16px * 2 + --pf-t--global--font--size--body--default) - 16px)",
        "calc(calc(16px * 2 + --pf-t--global--font--size--sm) - 16px)",
        "calc(calc(16px * 2 + --pf-t--global--font--size--200) - 16px)",
        "calc(calc(16px * 2 + 14px) - 16px)"
      ]
    },
    ...
    "c_tree_view_m_guides_guide_InsetInlineStart": {
      ...
      "value": "calc(calc(16px * 2 + 14px) - 24px)",
      "values": [
        ...
        "calc(calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default) - 24px)",
        "calc(calc(16px * 2 + --pf-t--global--font--size--body--default) - 24px)",
        "calc(calc(16px * 2 + --pf-t--global--font--size--sm) - 24px)",
        "calc(calc(16px * 2 + --pf-t--global--font--size--200) - 24px)",
        "calc(calc(16px * 2 + 14px) - 24px)"
      ]
    },
    ...
    "c_tree_view_m_guides_guide_left_base_offset": {
      ...
      "value": "calc(calc(16px * 2 + 14px) + 14px / 2)",
      "values": [
        ...
        "calc(calc(16px * 2 + --pf-t--global--font--size--body--default) + 14px / 2)",
        "calc(calc(16px * 2 + --pf-t--global--font--size--sm) + 14px / 2)",
        "calc(calc(16px * 2 + --pf-t--global--font--size--200) + 14px / 2)",
        "calc(calc(16px * 2 + 14px) + 14px / 2)"
      ]
    },
    ...
    "c_tree_view_m_compact__list_item_nested_last_child_before_Height": {
      ...
      "value": "calc(calc(24px + 8px + 0.25rem) + 8px)",
      "values": [
        ...
        "calc(calc(--pf-t--global--spacer--400 + --pf-t--global--spacer--200 + 0.25rem) + 8px)",
        "calc(calc(24px + 8px + 0.25rem) + 8px)"
      ]
    },
    ...
    "c_tree_view_m_compact_m_no_background_base_border_InsetInlineStart": {
      ...
      "value": "calc(calc(16px * 2 + 14px) - 8px)",
      "values": [
        ...
        "calc(calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default) - 8px)",
        "calc(calc(16px * 2 + --pf-t--global--font--size--body--default) - 8px)",
        "calc(calc(16px * 2 + --pf-t--global--font--size--sm) - 8px)",
        "calc(calc(16px * 2 + --pf-t--global--font--size--200) - 8px)",
        "calc(calc(16px * 2 + 14px) - 8px)"
      ]
    },
  ...
  ".pf-v6-c-tree-view.pf-m-compact .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item": {
    "c_tree_view_m_guides_guide_InsetInlineStart": {
      "name": "--pf-v6-c-tree-view--m-guides--guide--InsetInlineStart",
      "value": "calc(calc(16px * 2 + 14px) - calc(calc(16px * 2 + 14px) + 14px / 2))",
      "values": [
        ...
        "calc(calc(16px * 2 + --pf-t--global--font--size--body--default) - calc(calc(--pf-t--global--spacer--md * 2 + --pf-v6-c-tree-view__node-toggle-icon--MinWidth) + --pf-t--global--font--size--sm / 2))",
        "calc(calc(16px * 2 + --pf-t--global--font--size--sm) - calc(calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default) + --pf-t--global--font--size--200 / 2))",
        "calc(calc(16px * 2 + --pf-t--global--font--size--200) - calc(calc(16px * 2 + --pf-t--global--font--size--body--default) + 14px / 2))",
        "calc(calc(16px * 2 + 14px) - calc(calc(16px * 2 + --pf-t--global--font--size--sm) + 14px / 2))",
        "calc(calc(16px * 2 + 14px) - calc(calc(16px * 2 + --pf-t--global--font--size--200) + 14px / 2))",
        "calc(calc(16px * 2 + 14px) - calc(calc(16px * 2 + 14px) + 14px / 2))"
      ]
    },
    "c_tree_view__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view__node--PaddingInlineStart",
  ...
  ".pf-v6-c-tree-view.pf-m-compact.pf-m-no-background .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item": {
    ...
    "c_tree_view__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view__node--PaddingInlineStart",
      "value": "calc(48px * 1 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(48px * 1 + calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default))",
        "calc(48px * 1 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(48px * 1 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(48px * 1 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(48px * 1 + calc(16px * 2 + 14px))"
      ]
    }
  },
  ...
  ".pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item": {
    ...
    "c_tree_view__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view__node--PaddingInlineStart",
      "value": "calc(calc(calc(16px * 2 + 14px) - 16px) * 1 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(calc(calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default) - 16px) * 1 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--body--default) - 16px) * 1 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--sm) - 16px) * 1 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--200) - 16px) * 1 + calc(16px * 2 + 14px))",
        "calc(calc(calc(16px * 2 + 14px) - 16px) * 1 + calc(16px * 2 + 14px))"
      ]
    },
  ...
  ".pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item": {
    ...
    "c_tree_view__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view__node--PaddingInlineStart",
      "value": "calc(calc(calc(16px * 2 + 14px) - 16px) * 2 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(calc(calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default) - 16px) * 2 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--body--default) - 16px) * 2 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--sm) - 16px) * 2 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--200) - 16px) * 2 + calc(16px * 2 + 14px))",
        "calc(calc(calc(16px * 2 + 14px) - 16px) * 2 + calc(16px * 2 + 14px))"
      ]
    },
    "c_tree_view_m_guides_border_nested_InsetInlineStart": {
      "name": "--pf-v6-c-tree-view--m-guides--border--nested--InsetInlineStart",
    ...
    "c_tree_view_m_compact__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact__node--PaddingInlineStart",
      "value": "calc(24px * 1 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(24px * 1 + calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default))",
        "calc(24px * 1 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(24px * 1 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(24px * 1 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(24px * 1 + calc(16px * 2 + 14px))"
      ]
    },
  ...
  ".pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item": {
    ...
    "c_tree_view__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view__node--PaddingInlineStart",
      "value": "calc(calc(calc(16px * 2 + 14px) - 16px) * 3 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(calc(calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default) - 16px) * 3 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--body--default) - 16px) * 3 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--sm) - 16px) * 3 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--200) - 16px) * 3 + calc(16px * 2 + 14px))",
        "calc(calc(calc(16px * 2 + 14px) - 16px) * 3 + calc(16px * 2 + 14px))"
      ]
    },
    "c_tree_view_m_guides_border_nested_InsetInlineStart": {
      "name": "--pf-v6-c-tree-view--m-guides--border--nested--InsetInlineStart",
    ...
    "c_tree_view_m_compact__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact__node--PaddingInlineStart",
      "value": "calc(24px * 2 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(24px * 2 + calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default))",
        "calc(24px * 2 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(24px * 2 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(24px * 2 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(24px * 2 + calc(16px * 2 + 14px))"
      ]
    },
    "c_tree_view_m_compact_border_nested_InsetInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact--border--nested--InsetInlineStart",
    ...
    "c_tree_view_m_compact_m_no_background__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact--m-no-background__node--PaddingInlineStart",
      "value": "calc(48px * 2 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(48px * 2 + calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default))",
        "calc(48px * 2 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(48px * 2 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(48px * 2 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(48px * 2 + calc(16px * 2 + 14px))"
      ]
    },
    "c_tree_view_m_compact_m_no_background_border_nested_InsetInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact--m-no-background--border--nested--InsetInlineStart",
  ...
  ".pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item": {
    ...
    "c_tree_view__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view__node--PaddingInlineStart",
      "value": "calc(calc(calc(16px * 2 + 14px) - 16px) * 4 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(calc(calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default) - 16px) * 4 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--body--default) - 16px) * 4 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--sm) - 16px) * 4 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--200) - 16px) * 4 + calc(16px * 2 + 14px))",
        "calc(calc(calc(16px * 2 + 14px) - 16px) * 4 + calc(16px * 2 + 14px))"
      ]
    },
    "c_tree_view_m_guides_border_nested_InsetInlineStart": {
      "name": "--pf-v6-c-tree-view--m-guides--border--nested--InsetInlineStart",
    ...
    "c_tree_view_m_compact__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact__node--PaddingInlineStart",
      "value": "calc(24px * 3 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(24px * 3 + calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default))",
        "calc(24px * 3 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(24px * 3 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(24px * 3 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(24px * 3 + calc(16px * 2 + 14px))"
      ]
    },
    "c_tree_view_m_compact_border_nested_InsetInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact--border--nested--InsetInlineStart",
    ...
    "c_tree_view_m_compact_m_no_background__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact--m-no-background__node--PaddingInlineStart",
      "value": "calc(48px * 3 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(48px * 3 + calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default))",
        "calc(48px * 3 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(48px * 3 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(48px * 3 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(48px * 3 + calc(16px * 2 + 14px))"
      ]
    },
    "c_tree_view_m_compact_m_no_background_border_nested_InsetInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact--m-no-background--border--nested--InsetInlineStart",
  ...
  ".pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item": {
    ...
    "c_tree_view__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view__node--PaddingInlineStart",
      "value": "calc(calc(calc(16px * 2 + 14px) - 16px) * 5 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(calc(calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default) - 16px) * 5 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--body--default) - 16px) * 5 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--sm) - 16px) * 5 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--200) - 16px) * 5 + calc(16px * 2 + 14px))",
        "calc(calc(calc(16px * 2 + 14px) - 16px) * 5 + calc(16px * 2 + 14px))"
      ]
    },
    "c_tree_view_m_guides_border_nested_InsetInlineStart": {
      "name": "--pf-v6-c-tree-view--m-guides--border--nested--InsetInlineStart",
    ...
    "c_tree_view_m_compact__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact__node--PaddingInlineStart",
      "value": "calc(24px * 4 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(24px * 4 + calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default))",
        "calc(24px * 4 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(24px * 4 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(24px * 4 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(24px * 4 + calc(16px * 2 + 14px))"
      ]
    },
    "c_tree_view_m_compact_border_nested_InsetInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact--border--nested--InsetInlineStart",
    ...
    "c_tree_view_m_compact_m_no_background__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact--m-no-background__node--PaddingInlineStart",
      "value": "calc(48px * 4 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(48px * 4 + calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default))",
        "calc(48px * 4 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(48px * 4 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(48px * 4 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(48px * 4 + calc(16px * 2 + 14px))"
      ]
    },
    "c_tree_view_m_compact_m_no_background_border_nested_InsetInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact--m-no-background--border--nested--InsetInlineStart",
  ...
  ".pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item": {
    ...
    "c_tree_view__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view__node--PaddingInlineStart",
      "value": "calc(calc(calc(16px * 2 + 14px) - 16px) * 6 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(calc(calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default) - 16px) * 6 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--body--default) - 16px) * 6 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--sm) - 16px) * 6 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--200) - 16px) * 6 + calc(16px * 2 + 14px))",
        "calc(calc(calc(16px * 2 + 14px) - 16px) * 6 + calc(16px * 2 + 14px))"
      ]
    },
    "c_tree_view_m_guides_border_nested_InsetInlineStart": {
      "name": "--pf-v6-c-tree-view--m-guides--border--nested--InsetInlineStart",
    ...
    "c_tree_view_m_compact__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact__node--PaddingInlineStart",
      "value": "calc(24px * 5 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(24px * 5 + calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default))",
        "calc(24px * 5 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(24px * 5 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(24px * 5 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(24px * 5 + calc(16px * 2 + 14px))"
      ]
    },
    "c_tree_view_m_compact_border_nested_InsetInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact--border--nested--InsetInlineStart",
    ...
    "c_tree_view_m_compact_m_no_background__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact--m-no-background__node--PaddingInlineStart",
      "value": "calc(48px * 5 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(48px * 5 + calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default))",
        "calc(48px * 5 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(48px * 5 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(48px * 5 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(48px * 5 + calc(16px * 2 + 14px))"
      ]
    },
    "c_tree_view_m_compact_m_no_background_border_nested_InsetInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact--m-no-background--border--nested--InsetInlineStart",
  ...
  ".pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item": {
    ...
    "c_tree_view__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view__node--PaddingInlineStart",
      "value": "calc(calc(calc(16px * 2 + 14px) - 16px) * 7 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(calc(calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default) - 16px) * 7 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--body--default) - 16px) * 7 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--sm) - 16px) * 7 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--200) - 16px) * 7 + calc(16px * 2 + 14px))",
        "calc(calc(calc(16px * 2 + 14px) - 16px) * 7 + calc(16px * 2 + 14px))"
      ]
    },
    "c_tree_view_m_guides_border_nested_InsetInlineStart": {
      "name": "--pf-v6-c-tree-view--m-guides--border--nested--InsetInlineStart",
    ...
    "c_tree_view_m_compact__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact__node--PaddingInlineStart",
      "value": "calc(24px * 6 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(24px * 6 + calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default))",
        "calc(24px * 6 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(24px * 6 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(24px * 6 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(24px * 6 + calc(16px * 2 + 14px))"
      ]
    },
    "c_tree_view_m_compact_border_nested_InsetInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact--border--nested--InsetInlineStart",
    ...
    "c_tree_view_m_compact_m_no_background__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact--m-no-background__node--PaddingInlineStart",
      "value": "calc(48px * 6 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(48px * 6 + calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default))",
        "calc(48px * 6 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(48px * 6 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(48px * 6 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(48px * 6 + calc(16px * 2 + 14px))"
      ]
    },
    "c_tree_view_m_compact_m_no_background_border_nested_InsetInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact--m-no-background--border--nested--InsetInlineStart",
  ...
  ".pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item": {
    ...
    "c_tree_view__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view__node--PaddingInlineStart",
      "value": "calc(calc(calc(16px * 2 + 14px) - 16px) * 8 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(calc(calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default) - 16px) * 8 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--body--default) - 16px) * 8 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--sm) - 16px) * 8 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--200) - 16px) * 8 + calc(16px * 2 + 14px))",
        "calc(calc(calc(16px * 2 + 14px) - 16px) * 8 + calc(16px * 2 + 14px))"
      ]
    },
    "c_tree_view_m_guides_border_nested_InsetInlineStart": {
      "name": "--pf-v6-c-tree-view--m-guides--border--nested--InsetInlineStart",
    ...
    "c_tree_view_m_compact__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact__node--PaddingInlineStart",
      "value": "calc(24px * 7 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(24px * 7 + calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default))",
        "calc(24px * 7 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(24px * 7 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(24px * 7 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(24px * 7 + calc(16px * 2 + 14px))"
      ]
    },
    "c_tree_view_m_compact_border_nested_InsetInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact--border--nested--InsetInlineStart",
    ...
    "c_tree_view_m_compact_m_no_background__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact--m-no-background__node--PaddingInlineStart",
      "value": "calc(48px * 7 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(48px * 7 + calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default))",
        "calc(48px * 7 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(48px * 7 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(48px * 7 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(48px * 7 + calc(16px * 2 + 14px))"
      ]
    },
    "c_tree_view_m_compact_m_no_background_border_nested_InsetInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact--m-no-background--border--nested--InsetInlineStart",
  ...
  ".pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item": {
    ...
    "c_tree_view__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view__node--PaddingInlineStart",
      "value": "calc(calc(calc(16px * 2 + 14px) - 16px) * 9 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(calc(calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default) - 16px) * 9 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--body--default) - 16px) * 9 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--sm) - 16px) * 9 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--200) - 16px) * 9 + calc(16px * 2 + 14px))",
        "calc(calc(calc(16px * 2 + 14px) - 16px) * 9 + calc(16px * 2 + 14px))"
      ]
    },
    "c_tree_view_m_guides_border_nested_InsetInlineStart": {
      "name": "--pf-v6-c-tree-view--m-guides--border--nested--InsetInlineStart",
    ...
    "c_tree_view_m_compact__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact__node--PaddingInlineStart",
      "value": "calc(24px * 8 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(24px * 8 + calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default))",
        "calc(24px * 8 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(24px * 8 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(24px * 8 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(24px * 8 + calc(16px * 2 + 14px))"
      ]
    },
    "c_tree_view_m_compact_border_nested_InsetInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact--border--nested--InsetInlineStart",
    ...
    "c_tree_view_m_compact_m_no_background__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact--m-no-background__node--PaddingInlineStart",
      "value": "calc(48px * 8 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(48px * 8 + calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default))",
        "calc(48px * 8 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(48px * 8 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(48px * 8 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(48px * 8 + calc(16px * 2 + 14px))"
      ]
    },
    "c_tree_view_m_compact_m_no_background_border_nested_InsetInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact--m-no-background--border--nested--InsetInlineStart",
  ...
  ".pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item .pf-v6-c-tree-view__list-item": {
    ...
    "c_tree_view__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view__node--PaddingInlineStart",
      "value": "calc(calc(calc(16px * 2 + 14px) - 16px) * 10 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(calc(calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default) - 16px) * 10 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--body--default) - 16px) * 10 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--sm) - 16px) * 10 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(calc(calc(16px * 2 + --pf-t--global--font--size--200) - 16px) * 10 + calc(16px * 2 + 14px))",
        "calc(calc(calc(16px * 2 + 14px) - 16px) * 10 + calc(16px * 2 + 14px))"
      ]
    },
    "c_tree_view_m_guides_border_nested_InsetInlineStart": {
      "name": "--pf-v6-c-tree-view--m-guides--border--nested--InsetInlineStart",
    ...
    "c_tree_view_m_compact__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact__node--PaddingInlineStart",
      "value": "calc(24px * 9 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(24px * 9 + calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default))",
        "calc(24px * 9 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(24px * 9 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(24px * 9 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(24px * 9 + calc(16px * 2 + 14px))"
      ]
    },
    "c_tree_view_m_compact_border_nested_InsetInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact--border--nested--InsetInlineStart",
    ...
    "c_tree_view_m_compact_m_no_background__node_PaddingInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact--m-no-background__node--PaddingInlineStart",
      "value": "calc(48px * 9 + calc(16px * 2 + 14px))",
      "values": [
        ...
        "calc(48px * 9 + calc(--pf-t--global--spacer--300 * 2 + --pf-t--global--icon--size--font--body--default))",
        "calc(48px * 9 + calc(16px * 2 + --pf-t--global--font--size--body--default))",
        "calc(48px * 9 + calc(16px * 2 + --pf-t--global--font--size--sm))",
        "calc(48px * 9 + calc(16px * 2 + --pf-t--global--font--size--200))",
        "calc(48px * 9 + calc(16px * 2 + 14px))"
      ]
    },
    "c_tree_view_m_compact_m_no_background_border_nested_InsetInlineStart": {
      "name": "--pf-v6-c-tree-view--m-compact--m-no-background--border--nested--InsetInlineStart",
