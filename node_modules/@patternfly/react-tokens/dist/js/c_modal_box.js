...
exports.c_modal_box = {
  ":where(:root, .pf-v6-c-modal-box)": {
    ...
    "c_modal_box_m_align_top_MaxHeight": {
      ...
      "value": "calc(100% - min(8px, 48px) - 8px)",
      "values": [
        ...
        "calc(100% - min(--pf-t--global--spacer--200, 48px) - --pf-t--global--spacer--200)",
        "calc(100% - min(8px, 48px) - 8px)"
      ]
    },
    "c_modal_box_m_align_top_MaxWidth": {
      "name": "--pf-v6-c-modal-box--m-align-top--MaxWidth",
      "value": "calc(100% - min(8px * 2, 32px))",
      "values": [
        ...
        "calc(100% - min(--pf-t--global--spacer--200 * 2, 32px))",
        "calc(100% - min(8px * 2, 32px))"
      ]
    },
...
exports["default"] = exports.c_modal_box;