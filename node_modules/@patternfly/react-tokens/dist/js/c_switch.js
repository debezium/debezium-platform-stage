  ...
  ":where(:root, .pf-v6-c-switch)": {
    ...
    "c_switch__toggle_Height": {
      ...
      "values": [
        ...
        "calc(--pf-t--global--font--size--200 * --pf-t--global--font--line-height--100)",
        "calc(14px * 1.3)"
      ]
    },
    ...
    "c_switch__toggle_before_InsetInlineStart": {
      ...
      "value": "calc((calc(14px * 1.3) - calc(14px - 0.125rem)) / 2)",
      "values": [
        ...
        "calc((calc(--pf-t--global--font--size--200 * --pf-t--global--font--line-height--100) - calc(--pf-t--global--font--size--sm - 0.125rem)) / 2)",
        "calc((calc(14px * 1.3) - calc(--pf-t--global--font--size--200 - 0.125rem)) / 2)",
        "calc((calc(14px * 1.3) - calc(14px - 0.125rem)) / 2)"
      ]
    },
    ...
    "c_switch__toggle_Width": {
      ...
      "value": "calc(calc(14px * 1.3) + 0.125rem + calc(14px - 0.125rem))",
      "values": [
        ...
        "calc(calc(--pf-t--global--font--size--200 * --pf-t--global--font--line-height--100) + 0.125rem + calc(--pf-t--global--font--size--200 - 0.125rem))",
        "calc(calc(14px * 1.3) + 0.125rem + calc(14px - 0.125rem))"
      ]
    }
  },
...
exports["default"] = exports.c_switch;