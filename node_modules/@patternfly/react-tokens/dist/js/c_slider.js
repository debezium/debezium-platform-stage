...
exports.c_slider = {
  ":where(:root, .pf-v6-c-slider)": {
    ...
    "c_slider__value_c_form_control_width_base": {
      ...
      "value": "calc(16px + 16px + 1.25rem)",
      "values": [
        "calc(--pf-v6-c-form-control--PaddingInlineStart + --pf-v6-c-form-control--PaddingInlineEnd + 1.25rem)",
        "calc(--pf-v6-c-form-control--inset--base + --pf-v6-c-form-control--inset--base + 1.25rem)",
        "calc(--pf-t--global--spacer--md + --pf-t--global--spacer--md + 1.25rem)",
        "calc(--pf-t--global--spacer--300 + --pf-t--global--spacer--300 + 1.25rem)",
        "calc(16px + 16px + 1.25rem)"
      ]
    },
    ...
    "c_slider__value_c_form_control_Width": {
      ...
      "value": "calc(calc(16px + 16px + 1.25rem) + 3 * 1ch)",
      "values": [
        "calc(--pf-v6-c-slider__value--c-form-control--width-base + --pf-v6-c-slider__value--c-form-control--width-chars * 1ch)",
        "calc(calc(--pf-v6-c-form-control--PaddingInlineStart + --pf-v6-c-form-control--PaddingInlineEnd + 1.25rem) + 3 * 1ch)",
        "calc(calc(--pf-v6-c-form-control--inset--base + --pf-v6-c-form-control--inset--base + 1.25rem) + 3 * 1ch)",
        ...
        "calc(calc(16px + 16px + 1.25rem) + 3 * 1ch)"
      ]
    },
...
exports["default"] = exports.c_slider;