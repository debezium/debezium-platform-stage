export const c_badge = {
  ":where(:root, .pf-v6-c-badge)": {
    ...
    "c_badge__toggle_icon_MarginInlineStart": {
      "name": "--pf-v6-c-badge__toggle-icon--MarginInlineStart",
      "value": "4px",
      "values": [
    ...
    "c_badge__toggle_icon_Color": {
      "name": "--pf-v6-c-badge__toggle-icon--Color",
      "value": "#1f1f1f",
      "values": [
    ...
    "c_badge_m_read__toggle_icon_Color": {
    ...
    "c_badge_m_unread__toggle_icon_Color": {
      "name": "--pf-v6-c-badge--m-unread__toggle-icon--Color",
      "value": "#fff",
      "values": [
    ...
    "c_badge_m_disabled_BorderColor": {
    ...
    "c_badge_m_disabled_BackgroundColor": {
