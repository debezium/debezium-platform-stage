(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["VictoryGroup"] = factory(require("react"));
	else
		root["VictoryGroup"] = factory(root["React"]);
...
/* harmony export */   "useMemoizedProps": function() { return /* binding */ useMemoizedProps; }
/* harmony export */ });
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/wrapper.js");
...
/* harmony import */ var react_fast_compare__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-fast-compare */ "../../../node_modules/.pnpm/react-fast-compare@3.2.0/node_modules/react-fast-compare/index.js");
...
function getCalculatedProps(initialProps, childComponents) {
  const role = "group";
  const props = victory_core__WEBPACK_IMPORTED_MODULE_2__.modifyProps(initialProps, fallbackProps, role);
  const style = victory_core__WEBPACK_IMPORTED_MODULE_3__.getStyle(props.theme, props.style, role);
  const {
    offset,
    colorScale,
    color,
  ...
  const categories = props.categories || victory_core__WEBPACK_IMPORTED_MODULE_3__.getCategories(props, childComponents, null);
  const datasets = props.datasets || victory_core__WEBPACK_IMPORTED_MODULE_3__.getDataFromChildren(props, null);
  const domain = {
    x: victory_core__WEBPACK_IMPORTED_MODULE_3__.getDomain(Object.assign({}, props, {
      categories
    }), "x", childComponents),
    y: victory_core__WEBPACK_IMPORTED_MODULE_3__.getDomain(Object.assign({}, props, {
      categories
    }), "y", childComponents)
  };
  ...
  const baseScale = {
    x: victory_core__WEBPACK_IMPORTED_MODULE_4__.getScaleFromProps(props, "x") || victory_core__WEBPACK_IMPORTED_MODULE_3__.getScale(props, "x"),
    y: victory_core__WEBPACK_IMPORTED_MODULE_4__.getScaleFromProps(props, "y") || victory_core__WEBPACK_IMPORTED_MODULE_3__.getScale(props, "y")
  };
  const scale = {
    x: baseScale.x.domain(domain.x).range(props.horizontal ? range.y : range.x),
    y: baseScale.y.domain(domain.y).range(props.horizontal ? range.x : range.y)
  };
  const origin = polar ? props.origin : victory_core__WEBPACK_IMPORTED_MODULE_2__.getPolarOrigin(props);
...
const withoutSharedEvents = props => {
  ...
  const modifiedChildren = react__WEBPACK_IMPORTED_MODULE_0___default().Children.toArray(children).map(child => {
    return {
      ...child,
      props: victory_core__WEBPACK_IMPORTED_MODULE_2__.omit(child.props, ["sharedEvents"])
    };
  });
...
function useMemoizedProps(initialProps) {
  ...
  const [props, setProps] = react__WEBPACK_IMPORTED_MODULE_0___default().useState(modifiedProps);

  // React.memo uses shallow equality to compare objects. This way props
  // will only be re-calculated when they change.
  react__WEBPACK_IMPORTED_MODULE_0___default().useEffect(() => {
    if (!react_fast_compare__WEBPACK_IMPORTED_MODULE_1___default()(modifiedProps, props)) {
...
function pixelsToValue(props, axis, calculatedProps) {
  ...
  const currentAxis = victory_core__WEBPACK_IMPORTED_MODULE_2__.getCurrentAxis(axis, props.horizontal);
...
function getDataWithOffset(props, defaultDataset, offset) {
  ...
  const dataset = props.data || props.y ? victory_core__WEBPACK_IMPORTED_MODULE_5__.getData(props) : defaultDataset;
...
function getChildren(initialProps, childComponents, calculatedProps) {
  const props = victory_core__WEBPACK_IMPORTED_MODULE_2__.modifyProps(initialProps, fallbackProps, "stack");
  ...
  return children.map((child, index) => {
    ...
    const style = role === "voronoi" || role === "tooltip" || role === "label" ? child.props.style : victory_core__WEBPACK_IMPORTED_MODULE_3__.getChildStyle(child, index, newCalculatedProps);
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().cloneElement(child, Object.assign({
      labels,
      style,
      key: `${name}-key-${index}`,
      name,
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/hooks/use-animation-state.js");
...
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/wrapper.js");
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/hooks/use-previous-props.js");
/* harmony import */ var victory_shared_events__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! victory-shared-events */ "../../victory-shared-events/es/victory-shared-events.js");
...
const defaultProps = {
  containerComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_core__WEBPACK_IMPORTED_MODULE_4__.VictoryContainer, null),
...
const VictoryGroupBase = initialProps => {
  ...
  const {
    ...
    setAnimationState,
    getProps
  } = victory_core__WEBPACK_IMPORTED_MODULE_6__.useAnimationState();
  ...
  const modifiedProps = victory_core__WEBPACK_IMPORTED_MODULE_7__.modifyProps(props, fallbackProps, role);
  const {
    eventKey,
    containerComponent,
    standalone,
  ...
  const childComponents = react__WEBPACK_IMPORTED_MODULE_2___default().Children.toArray(modifiedProps.children);
  const calculatedProps = (0,_helper_methods__WEBPACK_IMPORTED_MODULE_8__.useMemoizedProps)(modifiedProps);
  const {
    domain,
    scale,
    style,
  ...
  const newChildren = react__WEBPACK_IMPORTED_MODULE_2___default().useMemo(() => {
    const children = (0,_helper_methods__WEBPACK_IMPORTED_MODULE_8__.getChildren)(props, childComponents, calculatedProps);
    return children.map((child, index) => {
  ...
  const userProps = react__WEBPACK_IMPORTED_MODULE_2___default().useMemo(() => victory_core__WEBPACK_IMPORTED_MODULE_9__.getSafeUserProps(propsWithDefaults), [propsWithDefaults]);
  const container = react__WEBPACK_IMPORTED_MODULE_2___default().useMemo(() => {
    if (standalone) {
      const defaultContainerProps = lodash_defaults__WEBPACK_IMPORTED_MODULE_1___default()({}, containerComponent.props, containerProps, userProps);
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().cloneElement(containerComponent, defaultContainerProps);
    }
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().cloneElement(groupComponent, userProps);
  ...
  const events = react__WEBPACK_IMPORTED_MODULE_2___default().useMemo(() => {
    return victory_core__WEBPACK_IMPORTED_MODULE_10__.getAllEvents(props);
  }, [props]);
  const previousProps = victory_core__WEBPACK_IMPORTED_MODULE_11__.usePreviousProps(propsWithDefaults);
  ...
  if (!lodash_isEmpty__WEBPACK_IMPORTED_MODULE_0___default()(events)) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(victory_shared_events__WEBPACK_IMPORTED_MODULE_12__.VictorySharedEvents, {
      container: container,
      eventKey: eventKey,
      events: events,
...
const componentConfig = {
  ...
  getChildren: _helper_methods__WEBPACK_IMPORTED_MODULE_8__.getChildren
};
const VictoryGroup = Object.assign( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().memo(VictoryGroupBase, (react_fast_compare__WEBPACK_IMPORTED_MODULE_3___default())), componentConfig);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "VictoryGroup": function() { return /* reexport safe */ _victory_group__WEBPACK_IMPORTED_MODULE_0__.VictoryGroup; }
/* harmony export */ });
/* harmony import */ var _victory_group__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./victory-group */ "./victory-group.tsx");
