...
export declare type TextAnchorType = "start" | "middle" | "end" | "inherit";
export declare type OriginType = {
    x: number;
    y: number;
};
export declare type LabelOrientationType = "parallel" | "perpendicular" | "vertical";
