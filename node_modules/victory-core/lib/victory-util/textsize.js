...
exports.convertLengthToPixels = exports.approximateTextSize = exports._approximateTextSizeInternal = void 0;
...
const _prepareParams = (inputStyle, index) => {
  ...
  const style = (0, _defaults2.default)({}, lineStyle, defaultStyle);
...
const _getMeasurementContainer = (0, _memoize2.default)(() => {
...
const _measureDimensionsInternal = (0, _memoize2.default)((text, style) => {
...
const _approximateTextSizeInternal = exports._approximateTextSizeInternal = {
